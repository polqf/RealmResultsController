// Generated by Apple Swift version 3.0 (swiftlang-800.0.34.6 clang-800.0.33)
...
/**
  ...
  \endcode and \code
  Object
  \endcode subclass properties can be
  optional. \code
  Int
  \endcode, \code
  Int8
...
- (RLMListBase * _Nonnull)listForPropertyWithProp:(RLMProperty * _Nonnull)prop;
- (RLMOptionalBase * _Nonnull)optionalForPropertyWithProp:(RLMProperty * _Nonnull)prop;
- (LinkingObjectsBase * _Nullable)linkingObjectsForPropertyWithProp:(RLMProperty * _Nonnull)prop;
@end
...
- (null_unspecified instancetype)initWithArray:(RLMArray<RLMObject *> * _Null_unspecified)array OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
